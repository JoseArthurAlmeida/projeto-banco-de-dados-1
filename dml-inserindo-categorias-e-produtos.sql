...
INSERT INTO produtos (id, nome, descricao, preco, quantidade, fk_categoria_id, url_imagem)
VALUES
	(1, 'Teclado com fio',
	 ...
	 25.0, 10, 1, 'teclado.png'),

	(2, 'Mouse com fio', 'Este mouse com fio oferece precisão e confiabilidade para todas as suas tarefas.', 10.0, 10,
	 2, 'mouse.png'),

	(3, 'Monitor 22 Polegadas Full HD',
	...
	(5, 'AMD FX-4300',
	 ...
	 160.0, 10, 4, 'amd_fx.png'),

	(6, 'Placa de vídeo - MSI ATI Radeon HD 5450',
	 ...
	 150.0, 10, 5, 'msi_5450.png'),
	(7, 'Placa de vídeo RX 550 4gb',
	 ...
	 400.0, 10, 5, 'rx550.png'),
	(8, 'Placa de vídeo - MSI GTX 1650',
	 ...
	 1200.0, 10, 5, 'msi_1650.png'),

	(9, 'Gabinete Gamer', 'Gabinete com led.', 350.0, 10, 6, 'gabinete_games.png'),
	(10, 'Gabinete', 'Gabinete comum.', 70.0, 10, 6, 'gabinete.png'),

	(11, 'Placa mãe lga 1155 b75', 'Placa mãe para processadores Intel soquete lga 1155 com chipset b75.', 300.0, 10, 7,
	 'placa_mae_1155_b75.png'),
	(12, 'Placa mãe Socket AM3+', 'Placa mãe para processadores AMD soquete AM3+.', 300.0, 10, 7, 'placa_mae_am3+.png'),

	(13, 'Memória ram 8gb DDR3', 'Memória ram 8gb DDR3 com frequência de 1333 MHz.', 60.0, 10, 8, 'ram_ddr3.png'),
	(14, 'Memória ram 8gb DDR4', 'Memória ram 8gb DDR4 com frequência de 3200 MHz.', 150.0, 10, 8, 'ram_ddr4.png');